...
values."
  (setq-default
   ...
   '(
     ...
     git
     markdown
     ;; https://github.com/syl20bnr/spacemacs/issues/10434
     ;; org
     osx
     (shell :variables
   ...
   dotspacemacs-additional-packages '(all-the-icons eterm-256color)
...
you should place your code here."
  ...
  ;; Config magit repo root
  (setq magit-repository-directories '("~/Development/repos/git/"))
  )
